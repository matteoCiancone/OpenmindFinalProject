window.onload = function hideRow6() {
    document.querySelector(".cardRow6").setAttribute("hidden", "hidden");
    document.querySelector(".gridBtn6").style.opacity = "50%"
}

/*********PRODUCTS GRID DISPLAY***********/
function displayRow4() {
    document.querySelector(".cardRow4").removeAttribute("hidden");
    document.querySelector(".cardRow6").setAttribute("hidden", "hidden");
    document.querySelector(".gridBtn6").style.opacity = "50%";
...
function displayRow6() {
    document.querySelector(".cardRow4").setAttribute("hidden", "hidden");
    document.querySelector(".cardRow6").removeAttribute("hidden");
